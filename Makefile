...
8bit/%.o: CPPFLAGS += -DHIGH_BIT_DEPTH=0 -DBIT_DEPTH=8
8bit/%.o: ASFLAGS += -DHIGH_BIT_DEPTH=0 -DBIT_DEPTH=8 -Dprivate_prefix=x264_8
10bit/%.o: CPPFLAGS += -DHIGH_BIT_DEPTH=1 -DBIT_DEPTH=10
10bit/%.o: ASFLAGS += -DHIGH_BIT_DEPTH=1 -DBIT_DEPTH=10 -Dprivate_prefix=x264_10

%.o 8bit/%.o 10bit/%.o: %.c
	@mkdir -p $(dir $@)
	$(CC) $(CFLAGS) $(CPPFLAGS) -c $< -o $@

%.o 8bit/%.o 10bit/%.o: %.asm common/x86/x86inc.asm common/x86/x86util.asm
	@mkdir -p $(dir $@)
	$(AS) $(ASFLAGS) -o $@ $<
