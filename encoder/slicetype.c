...
static void vbv_lookahead_internal( x264_t *h, x264_mb_analysis_t *a, x264_frame_t **frames, int num_frames, int keyframe )
{
...
void x264_slicetype_analyse( x264_t *h, int intra_minigop )
{
    ...
    if( vbv_lookahead )
        vbv_lookahead_internal( h, &a, frames, num_frames, keyframe );
